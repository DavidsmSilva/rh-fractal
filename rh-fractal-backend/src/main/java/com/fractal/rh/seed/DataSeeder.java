...
public class DataSeeder implements CommandLineRunner {
  ...
  private void seedIfNeeded(String table) {
    ...
    if ("departamentos".equals(table)) {
      ...
      Nomina n6 = Nomina.builder().empleadoId(6L).nombreEmpleado("Sofía Hernández").periodo("2026-01").periodoNomina("2026-01").fechaPago(LocalDate.of(2026, 1, 31)).totalDevengado(35000.0).totalDeducciones(3500.0).totalNeto(31500.0).estado("PAGADO").build();
      Nomina n7 = Nomina.builder().empleadoId(7L).nombreEmpleado("Diego Torres").periodo("2026-01").periodoNomina("2026-01").fechaPago(LocalDate.of(2026, 1, 31)).totalDevengado(62000.0).totalDeducciones(6200.0).totalNeto(55800.0).estado("PAGADO").build();
      ...
      Vacacion v11 = Vacacion.builder().empleadoId(6L).nombreEmpleado("Sofía Hernández").periodoVacacional("2026-12").dias(5).diasTotales(25).estado("PENDIENTE").fechaSolicitud(LocalDate.of(2026, 3, 1)).build();
      Vacacion v12 = Vacacion.builder().empleadoId(12L).nombreEmpleado("Valentina Morales").periodoVacacional("2026-12").dias(3).diasTotales(25).estado("APROBADO").fechaSolicitud(LocalDate.of(2026, 3, 5)).build();
